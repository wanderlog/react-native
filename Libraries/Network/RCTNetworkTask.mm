...
- (void)start
{
  ...
  if (_requestToken == nil) {
    ...
    if ([self validateRequestToken:token]) {
      ...
      //
      // It's possible this problem was fixed by https://github.com/facebook/react-native/pull/44694
      // but intuitively, it should still be plausible so we keep this as an
