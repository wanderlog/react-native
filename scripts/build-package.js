...
function cleanupStaleCodegenArtifacts() {
  // We added these because git reset --hard HEAD doesn't delete stale files
  // in gitignored directories and were causing failures to build when a stale
  // FBReactNativeSpecJSI-generated.cpp remained
